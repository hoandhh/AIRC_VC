...
def get_response(s):
    question = "Hãy sinh ra 1 câu có dạng : Hiện tại lớp học đang có {nhãn} bạn đang {nhãn} và 1 câu nhận xét duy nhất dựa trên dữ liệu sau: "
    message = question + s
    response = chat_session.send_message(message)
    return response.text

# print(get_response("2 readings, 2 readings, 2 readings, 2 readings, 5 sleep, 6 use phone,"))
# print(get_response(get_data()))
